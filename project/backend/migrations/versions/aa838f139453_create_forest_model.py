...
def upgrade():
    ...
    sa.Column('type', postgresql.ENUM('Conservation', 'Reforestation', name='type'), nullable=True),
    ...
    sa.Column('bear_mortality', postgresql.ENUM('Low', 'Medium', 'High', 'N/A', name='bear_mortality'), nullable=True),
    sa.Column('critical_fire_risk', postgresql.ENUM('Low', 'Medium', 'High', 'N/A', name='critical_fire_risk'), nullable=True),
    sa.Column('stream_flow', postgresql.ENUM('Low', 'Medium', 'High', 'N/A', name='stream_flow'), nullable=True),
